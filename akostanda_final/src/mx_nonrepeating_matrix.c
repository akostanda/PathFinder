...
static unsigned int **nonrepeating_matrix_filling(int **matrix,
int island_index, int *size, const int width) {
    unsigned int ***allmatrix = mx_allminways_matrix(matrix, island_index,
    size, width);
...
int *size, const int width) {
    unsigned int **norepmat = nonrepeating_matrix_filling(matrix,
