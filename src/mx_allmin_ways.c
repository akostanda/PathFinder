...
static void min_ways_cycle(const char *file, unsigned long **minwaymat, t_ints *n) {
...
static void parallel_ways_cycle(const char *file, unsigned long **minwaymat, t_ints *n, t_minways **list) {
    int **matrix = mx_matrix_filling(file);
    int width = mx_matrix_width(file);
